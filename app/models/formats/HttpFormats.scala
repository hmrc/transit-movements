...
trait HttpFormats extends CommonFormats {
  ...
  implicit val departureMessageTypeFormat: Format[DepartureMessageType] =
    enumFormat(MessageType.departureValues)(_.code)

  implicit val arrivalMessageTypeFormat: Format[ArrivalMessageType] =
    enumFormat(MessageType.arrivalValues)(_.code)
}
