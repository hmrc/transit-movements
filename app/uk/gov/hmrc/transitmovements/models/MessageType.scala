...
object MessageType {
  ...
  /** E_DEC_INV (IE014) */
  final private case object DeclarationInvalidation extends DepartureRequestMessageType("IE014", "CC014C", "/xsd/CC014C.xsd")

  /** E_DEC_DAT (IE015) */
  final case object DeclarationData extends DepartureRequestMessageType("IE015", "CC015C", "/xsd/CC015C.xsd")

  /** E_REQ_REL (IE054) */
  final private case object RequestOfRelease extends DepartureRequestMessageType("IE054", "CC054C", "/xsd/CC054C.xsd")

  /** E_PRE_NOT (IE170) */
  final private case object PresentationNotification extends DepartureRequestMessageType("IE170", "CC170C", "/xsd/CC170C.xsd")
  ...
  /** E_AMD_ACC (IE004) */
  final private case object AmendmentAcceptance extends DepartureResponseMessageType("IE004", "CC004C", "/xsd/CC004C.xsd")

  /** E_DEP_REJ (IE056) */
  final case object DepartureOfficeRejection extends DepartureResponseMessageType("IE056", "CC056C", "/xsd/CC056C.xsd")

  /** E_INV_DEC (IE009) */
  final private case object InvalidationDecision extends DepartureResponseMessageType("IE009", "CC009C", "/xsd/CC009C.xsd")

  /** E_GUA_INV (IE055) */
  final private case object GuaranteeInvalid extends DepartureResponseMessageType("IE055", "CC055C", "/xsd/CC055C.xsd")

  /** E_DIS_SND (IE019) */
  final private case object Discrepancies extends DepartureResponseMessageType("IE019", "CC019C", "/xsd/CC019C.xsd")

  /** E_POS_ACK (IE928) */
  final private case object PositiveAcknowledge extends DepartureResponseMessageType("IE928", "CC928C", "/xsd/CC928C.xsd")
  ...
  /** E_WRT_NOT (IE045) */
  final private case object WriteOffNotification extends DepartureResponseMessageType("IE045", "CC045C", "/xsd/CC045C.xsd")

  /** E_REL_NOT (IE051) */
  final private case object NoReleaseForTransit extends DepartureResponseMessageType("IE051", "CC051C", "/xsd/CC051C.xsd")

  /** E_CTR_DEC (IE060) */
  final private case object ControlDecisionNotification extends DepartureResponseMessageType("IE060", "CC060C", "/xsd/CC060C.xsd")

  /** E_AMD_NOT (IE022) */
  final private case object NotificationToAmend extends DepartureResponseMessageType("IE022", "CC022C", "/xsd/CC022C.xsd")

  /** E_INC_NOT (IE182) */
  final private case object IncidentNotification extends DepartureResponseMessageType("IE182", "CC182C", "/xsd/CC182C.xsd")

  /** E_REC_NOT (IE035) */
  final private case object RecoveryNotification extends DepartureResponseMessageType("IE035", "CC035C", "/xsd/CC035C.xsd")

  final private case object RequestOnNonArrivedMovement extends DepartureResponseMessageType("IE140", "CC140C", "/xsd/CC140C.xsd")
  ...
  /** E_PRE_NOT (IE170) */
  final private case object UnloadingRemarks extends ArrivalRequestMessageType("IE044", "CC044C", "/xsd/CC044C.xsd")
  ...
  /** E_DES_REJ (IE057) */
  final private case object DestinationOfficeRejection extends ArrivalResponseMessageType("IE057", "CC057C", "/xsd/CC057C.xsd")

  /** E_GDS_REL (IE025) */
  final private case object GoodsReleaseNotification extends ArrivalResponseMessageType("IE025", "CC025C", "/xsd/CC025C.xsd")

  /** E_ULD_PER (IE025) */
  final private case object UnloadingPermission extends ArrivalResponseMessageType("IE043", "CC043C", "/xsd/CC043C.xsd")
  ...
  final private case object XmlNack extends ErrorMessageType("IE917", "CC917C", "/xsd/CC917C.xsd")
